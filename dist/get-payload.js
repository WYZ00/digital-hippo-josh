        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ secret: process.env.PAYLOAD_SECRET, local: (initOptions === null || initOptions === void 0 ? void 0 : initOptions.express) ? false : true, email: {
                                transport: transporter,
                                fromAddress: "htooaung12341@gmail.com",
