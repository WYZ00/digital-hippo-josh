...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, limit, sort, queryOtps, payload, parsedQueryOtps, page, _b, items, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        limit = query.limit, sort = query.sort, queryOtps = __rest(query, ["limit", "sort"]);
                        return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                    case 1:
                        payload = _c.sent();
                        parsedQueryOtps = {};
                        Object.entries(queryOtps).forEach(function (_a) {
