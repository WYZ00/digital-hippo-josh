  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden md:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        ...
        />
        <div className="">
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 lg:gap-y-32">
            <div className="lg:col-start-2">
              ...
              {order._isPaid ? (
                <p className="mt-2 text-muted-foreground">
                  Your order was processed and your assets are avaliable to
                  download below.We&aois;ve sent your receipt and order details
                  to{" "}
